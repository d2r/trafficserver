...
.. class:: template<typename Derived_t> Extendible
   ...
   .. function:: template<> bool const get(BitFieldId field) const

   .. function:: template<> bool const readBit(BitFieldId field) const
   ...
   .. function:: template<> void * get(FieldId_C & field)
